<div>
    <div class="bg-white rounded-lg shadow-lg mb-6">
        <div class="px-6 py-2 flex justify-between items-center">
            <h1 class="font-semibold text-gray-700"><i>{!!$category->icon!!}</i> {{$category->name}}</h1>
            <div class=" hidden md:grid grid-cols-2 border border-gray-200 divide-x divide-gray-200 text-gray-500 cursor-pointer">
    ...
    <div class="grid grid-cols-1  sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-5 gap-6">
        <aside>
            ...
            <h2 class="font-semibold mb-2 text-center">Subcategorias</h2>
            ...
            <!--Marcas-->
            <h2 class="font-semibold mb-2 text-center">Marcas</h2>
            <ul class="divide-y divide-gray-200">
